...
export class AutoClient {
    ...
    private async registerAgent(): Promise<void> {
        ...
        console.log("actions", this.runtime.actions);
        console.log("actions names", this.runtime.actions.map(a => a.name));
        console.log('plugins', this.runtime.plugins);
        ...
        ` + messageCompletionFooter + `The available actions are ${this.runtime.actions.map(a => a.name).join(", ")} text should contain the registration payload`;
