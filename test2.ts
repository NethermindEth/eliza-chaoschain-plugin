import { composeContext, elizaLogger, embed } from "@elizaos/core";
import { generateMessageResponse } from "@elizaos/core";
import { messageCompletionFooter } from "@elizaos/core";
import { Content, HandlerCallback, IAgentRuntime, Memory, ModelClass } from "@elizaos/core";
import { stringToUuid } from "@elizaos/core";
import { WebsocketManager } from "./plugin/client-auto/src/websocketManager";
...
class AutoClient {
    ...
    private async registerAgent(): Promise<void> {
        ...
        const registrationTemplate = `You are a registration agent for ChaosChain. Your task is to register a new agent.

Registration Payload:
${JSON.stringify(registrationPayload, null, 2)}

Proceed with registration using the above details.
` + messageCompletionFooter;
